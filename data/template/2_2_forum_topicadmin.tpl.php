...
<?php if(empty($hiddensubmit)) { ?>
    <?php if($_GET['optgroup'] == 3 && $operation == 'delete' && $_G['group']['allowbanuser']) { ?>
        <div class="c">
            <div class="tpclg">
    		            <h4 class="cl">
    		                <p class="y">
    		                    <label for="userban"><input type="checkbox" name="banuser" id="userban" class="pc" />禁言</label>
    		                    <label for="userdelpost"><input type="checkbox" name="userdelpost" id="userdelpost" class="pc" />清空帖子</label>
    		                </p>
    		                <span>用户操作:</span>
    		            </h4>
    		        </div>
