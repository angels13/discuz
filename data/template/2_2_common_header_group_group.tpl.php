...
0
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_common.htm', 1526694986, '2', './data/template/2_2_common_header_group_group.tpl.php', './template/yeei_dream1', 'common/header_group_group')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_qmenu.htm', 1526694986, '2', './data/template/2_2_common_header_group_group.tpl.php', './template/yeei_dream1', 'common/header_group_group')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/yeei_dream1/common/pubsearchform.htm', 1526694986, '2', './data/template/2_2_common_header_group_group.tpl.php', './template/yeei_dream1', 'common/header_group_group')
;?>
