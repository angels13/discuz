...
0
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_common.htm', 1531797468, '2', './data/template/2_2_common_header_portal_portalcp.tpl.php', './template/yeei_dream1', 'common/header_portal_portalcp')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_qmenu.htm', 1531797468, '2', './data/template/2_2_common_header_portal_portalcp.tpl.php', './template/yeei_dream1', 'common/header_portal_portalcp')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/yeei_dream1/common/pubsearchform.htm', 1531797468, '2', './data/template/2_2_common_header_portal_portalcp.tpl.php', './template/yeei_dream1', 'common/header_portal_portalcp')
;?>
...
<div class="nv_r">
<a href="javascript:;" id="qmenu" onMouseOver="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})"></a></div>
</div>
</div>
<div class="head_logo"><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h2></div>
...
<div class="c_yt">
<div class="c_yt2">
<div class="c_r"><div class="c_l"><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
<div class="avt"><a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>"><?php echo avatar($_G[uid],small);?></a></div><?php include template('common/header_userstatus'); ?></div></div>
</div>
</div>
</div>
<div class="c_yc">
