...
0
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_common.htm', 1530770620, '2', './data/template/2_2_common_header.tpl.php', './template/yeei_dream1', 'common/header')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_qmenu.htm', 1530770620, '2', './data/template/2_2_common_header.tpl.php', './template/yeei_dream1', 'common/header')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/yeei_dream1/common/pubsearchform.htm', 1530770620, '2', './data/template/2_2_common_header.tpl.php', './template/yeei_dream1', 'common/header')
;?>
