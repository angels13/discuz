...
0
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_common.htm', 1526602039, '2', './data/template/2_2_common_header_member_activate.tpl.php', './template/yeei_dream1', 'common/header_member_activate')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_qmenu.htm', 1526602039, '2', './data/template/2_2_common_header_member_activate.tpl.php', './template/yeei_dream1', 'common/header_member_activate')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/yeei_dream1/common/pubsearchform.htm', 1526602039, '2', './data/template/2_2_common_header_member_activate.tpl.php', './template/yeei_dream1', 'common/header_member_activate')
;?>
