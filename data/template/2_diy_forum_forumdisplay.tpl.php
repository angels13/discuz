...
0
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1526464774, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1526464774, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1526464774, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/yeei_dream1/forum/forumdisplay_list.htm', 1526464774, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1526464774, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1526464774, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1526464774, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
...
<?php } ?>																				<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_thread'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_thread'][$key];?>
